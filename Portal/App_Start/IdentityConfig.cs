...
namespace Portal
{
    public class MyUserValidator : UserValidator<ApplicationUser>
    {
        public MyUserValidator(UserManager<ApplicationUser, string> manager) : base(manager)
        {
        }
        ...
        public override async Task<IdentityResult> ValidateAsync(ApplicationUser item)
        {
            ...
            if (item.PhoneNumber == null || item.PhoneNumber == "")
                identityResult = new IdentityResult("PhoneNumber is empty!");
            else
            {
